    ...
    public class Note : Gtk.Window {
        ...
        construct {
            ...
            action.activate += () => {
                ...
                Gtk.Dialog dialog = new Gtk.Dialog.with_buttons ("Key bindings",
                                                                 this,
        ...
        private void open () {
            ...
            Gtk.FileChooserDialog open_dialog = new Gtk.FileChooserDialog ("Open...",
                                                                           this,
            ...
            do {
                ...
                if (response == Gtk.ResponseType.OK) {
                    ...
                    try {
                         ...
                         * choose another file */
                        Gtk.MessageDialog error_dialog = new Gtk.MessageDialog (open_dialog,
        ...
        private void save () {
            ...
            try {
                ...
                Gtk.MessageDialog error_dialog = new Gtk.MessageDialog (this,
                                                                        Gtk.DialogFlags.MODAL,
                                                                        Gtk.MessageType.ERROR,
                                                                        Gtk.ButtonsType.OK,
                                                                        e.message);
            ...
            do {
                ...
                if (response == Gtk.ResponseType.OK) {
                    ...
                    try {
                        ...
                        /* Show an error message, then let the user
                         * choose another file */
                        Gtk.MessageDialog error_dialog = new Gtk.MessageDialog (save_as_dialog,
                                                                                Gtk.DialogFlags.MODAL,
                                                                                Gtk.MessageType.ERROR,
                                                                                Gtk.ButtonsType.OK,
                                                                                e.message);
